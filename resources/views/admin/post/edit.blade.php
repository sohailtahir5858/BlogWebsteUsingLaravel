                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="title" name="title" required="required"
                                class="form-control " value="{{$result[0]->title}}">
                        </div>
                        <span>@error('title')
                            {{$message}}
                        @enderror</span>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="short_desc" name="short_desc" required="required"
                                class="form-control" value="{{$result[0]->short_desc}}">
                        </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <textarea id="long_desc" rows="3" name="long_desc" required="required"
                                class="form-control">{{$result[0]->long_desc}}</textarea>
                        </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="date" name="post_date"
                                class="form-control datepicker" data-date-format="YYYY-MM-DD" value="{{ $result[0]->post_date}}">
                        </div>
